...
import TerminalOverlay from "common/TerminalOverlay";
import ChatImage from "../../assets/images/tech.jpg"
import UserChats from "common/UserChats";
import FeatureHighlightCard from "common/Features";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            ...
            <div className="lg:col-span-7 space-y-8 relative order-2 lg:order-1">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                ...
                <div className="pt-2">
                  <span className="text-foreground">With People</span>
                </div>
                <div className="pt-2">
                  <span className="text-foreground">Across the</span>
              ...
              Start real-time conversations, create private rooms, and experience seamless communication with our modern chat platform.
              </p>
              ...
              <div className="flex items-center gap-10 py-6 font-mono">
                ...
                <div className="flex flex-col">
                  <div className="text-2xl text-primary">50ms</div>
